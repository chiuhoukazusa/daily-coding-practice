...
int h(Pt a,Pt b){return 10*max(abs(a.x-b.x),abs(a.y-b.y))+4*min(abs(a.x-b.x),abs(a.y-b.y));}
...
int main(){
    int seed = 42;
    G g = maze(128,128,seed);
    Pt s{0,0},t{127,127};
    int dcost = dijkstra(g,s,t);
    printf("128x128 seed=42: Dijkstra = %d\n", dcost);
    
    seed = 179;
    G g2 = maze(128,128,seed);
    dcost = dijkstra(g2,s,t);
    printf("128x128 seed=179: Dijkstra = %d\n", dcost);
    return 0;
}
